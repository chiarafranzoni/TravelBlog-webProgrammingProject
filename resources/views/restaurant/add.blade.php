...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      <li><a class="dropdown-item current" href="{{route('restaurant.index')}}">Restaurants</a></li>
  ...
  <div class="external"  id='elementForm' >
    ...
    <div class="container" >
      ...
      <div class="row">
        ...
        <form name='restaurant' method="post" action="{{route('restaurant.store')}}" enctype="multipart/form-data">
            ...
            <a class="btn btn-secondary" href="{{route('restaurant.index')}}"> Cancel</a>
            <input class="btn subscribeForm-btn" type="submit" value="Submit" onclick="checkForm(event,'RESTAURANT', 'Submit');">
        ...
        <div class="row">
            ...
            <div  style="display: block; text-align:center; margin-bottom:2em;  height: 200px">
                ...
                <div style="display: flex; justify-content:center; margin-top:3em;">
                   ...
                   <a href="{{route('restaurant.index')}}"> <button class="btn btn-light" style="margin-right: 1.5em"> Go back</button> </a>
                    
                  <button class="btn btn-success" onclick="addProceed('RESTAURANT')"> Proceed </button>
                </div>
            </div>
        </div>
    </div>
